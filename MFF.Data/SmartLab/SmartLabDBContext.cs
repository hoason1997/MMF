...
{
    public class SmartLabDBContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        public SmartLabDBContext(DbContextOptions<SmartLabDBContext> options)
        : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<LenhSanXuatImport>()
             .HasMany(c => c.LenhSanXuatExport)
             .WithOne(e => e.LenhSanXuatImport)
         .OnDelete(DeleteBehavior.Cascade).IsRequired();


            //  .WithMany(b => b.LenhSanXuatImport)

            builder.Entity<ThongTinTieuHaoImport>()
               .HasKey(c => new { c.Id });
