...
{
    public class ChiDaoSanXuatAddModel
    {
        [Key]
        ...
        [Required(ErrorMessage = "Người kết thúc không được phép bỏ trống")]
        [DisplayName("Người kết thúc công việc")]
        public string? NguoiKetThucCongViec { get; set; }
