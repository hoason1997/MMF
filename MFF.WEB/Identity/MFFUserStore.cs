...
namespace MFF.WEB.Identity
{
    public class MFFUserStore : IUserPasswordStore<User>, IUserEmailStore<User>
    {
        private readonly MFFDbContext _context;

        public MFFUserStore(MFFDbContext context)
        {
            _context = context;
        }
